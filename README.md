...
<span style="color:green;">Зелёным цветом</span> 
будут выделены найденные n-граммы. Для точности они также будут продублированы ниже списком.
<span style="color:purple;">Фиолетовым цветом</span> 
будут выделены найденные «биномы».
<span style="color:red;">Красным цветом</span> 
будут выделены найденные междометия.
<span style="color:blue;">Синим цветом</span> 
будут выделены найденные фразеологизмы.
