...
<p style="color: green;">Зелёным цветом</p> будут выделены найденные n-граммы. Для точности они также будут продублированы ниже списком.

<p style="color: purple;">Фиолетовым цветом</p> будут выделены найденные «биномы».

<p style="color: red;">Красным цветом</p> будут выделены найденные междометия.

<p style="color: blue;">Синим цветом</p> будут выделены найденные фразеологизмы.
