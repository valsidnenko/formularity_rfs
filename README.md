...
4. Создайте новую ветку для ваших изменений. Рекомендуется назвать ветку так, чтобы отражать суть изменения:

Код:

    git checkout -b имя-вашей-ветки
   
6. Внесите изменения и закоммитьтесь:
...
8. Запушьте ваши изменения на ваш форк:

Код:

    git push origin имя-вашей-ветки
   
10. Перейдите на страницу вашего форка на GitHub и создайте Pull Request. Подробнее о том, как это сделать, можно прочитать в [официальной документации GitHub](https://docs.github.com/en/pull-requests).
